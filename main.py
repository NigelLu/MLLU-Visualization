...
drawline(data=df_EM, x_label="Data Ratio", y_label="Average Metrics", save_config=[
        True, "phase1-horizontal-em.png"])
drawline(data=df_F1, x_label="Data Ratio", y_label="Average Metrics", save_config=[
        True, "phase1-horizontal-f1.png"])
drawline(data=df_AVG, x_label="Data Ratio", y_label="Average Metrics", save_config=[
